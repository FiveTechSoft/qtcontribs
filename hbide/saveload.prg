...
METHOD IdeSetup:setIcons()
   WITH OBJECT ::oUI
      :buttonAddTextExt    : setIcon( QIcon( hbide_image( "dc_plus"   ) ) )
      :buttonDelTextExt    : setIcon( QIcon( hbide_image( "dc_delete" ) ) )
      :buttonKeyAdd        : setIcon( QIcon( hbide_image( "dc_plus"   ) ) )
      :buttonKeyDel        : setIcon( QIcon( hbide_image( "dc_delete" ) ) )
      :buttonKeyUp         : setIcon( QIcon( hbide_image( "dc_up"     ) ) )
      :buttonKeyDown       : setIcon( QIcon( hbide_image( "dc_down"   ) ) )
      /* Paths */
      :buttonPathHrbRoot   : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonPathHbmk2     : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonPathEnv       : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonPathResources : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonPathTemp      : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonPathShortcuts : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonPathSnippets  : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonPathThemes    : setIcon( QIcon( hbide_image( "open"      ) ) )
      //   
      :buttonViewIni       : setIcon( QIcon( hbide_image( "file-open" ) ) )
      :buttonViewEnv       : setIcon( QIcon( hbide_image( "file-open" ) ) )
      :buttonViewSnippets  : setIcon( QIcon( hbide_image( "file-open" ) ) )
      :buttonViewThemes    : setIcon( QIcon( hbide_image( "file-open" ) ) )
      :buttonSelFont       : setIcon( QIcon( hbide_image( "font"      ) ) )
      :buttonThmAdd        : setIcon( QIcon( hbide_image( "dc_plus"   ) ) )
      :buttonThmDel        : setIcon( QIcon( hbide_image( "dc_delete" ) ) )
      :buttonThmApp        : setIcon( QIcon( hbide_image( "copy"      ) ) )
      :buttonThmSav        : setIcon( QIcon( hbide_image( "save"      ) ) )
      /* VSS */
      :buttonVSSExe        : setIcon( QIcon( hbide_image( "open"      ) ) )
      :buttonVSSDatabase   : setIcon( QIcon( hbide_image( "open"      ) ) )
   ENDWITH
   RETURN Self
...
METHOD IdeSetup:connectSlots()
   WITH OBJECT ::oUI
      :buttonAddTextExt    :connect( "clicked()"               , {| | ::execEvent( __buttonAddTextext_clicked__                       ) } )
      :buttonDelTextExt    :connect( "clicked()"               , {| | ::execEvent( __buttonDelTextext_clicked__                       ) } )
      :buttonKeyAdd        :connect( "clicked()"               , {| | ::execEvent( __buttonKeyAdd_clicked__                           ) } )
      :buttonKeyDel        :connect( "clicked()"               , {| | ::execEvent( __buttonKeyDel_clicked__                           ) } )
      :buttonKeyUp         :connect( "clicked()"               , {| | ::execEvent( __buttonKeyUp_clicked__                            ) } )
      :buttonKeyDown       :connect( "clicked()"               , {| | ::execEvent( __buttonKeyDown_clicked__                          ) } )
      :buttonSelFont       :connect( "clicked()"               , {| | ::execEvent( __buttonSelFont_clicked__                          ) } )
      :editPointSize       :connect( "textEdited(QString)"     , {|s| ::oINI:nPointSize := Val( s )                                     } )
      :buttonClose         :connect( "clicked()"               , {| | ::execEvent( __buttonClose_clicked__                            ) } )
      :buttonOk            :connect( "clicked()"               , {| | ::execEvent( __buttonOk_clicked__                               ) } )
      :buttonCancel        :connect( "clicked()"               , {| | ::execEvent( __buttonCancel_clicked__                           ) } )
      :treeWidget          :connect( "itemSelectionChanged()"  , {| | ::execEvent( __treeWidget_itemSelectionChanged__                ) } )
      :comboStyle          :connect( "currentIndexChanged(int)", {|i| ::execEvent( __comboStyle_currentIndexChanged__       , i       ) } )
      :checkAnimated       :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkAnimated_stateChanged__           , i       ) } )
      :checkHilightLine    :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkHilightLine_stateChanged__        , i       ) } )
      :checkHorzRuler      :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkHorzRuler_stateChanged__          , i       ) } )
      :checkLineNumbers    :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkLineNumbers_stateChanged__        , i       ) } )
      :checkShowLeftToolbar:connect( "stateChanged(int)"       , {|i| ::execEvent( __checkShowLeftToolbar_stateChanged__    , i       ) } )
      :checkShowTopToolbar :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkShowTopToolbar_stateChanged__     , i       ) } )
      :checkShowSelToolbar :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkShowSelToolbar_stateChanged__     , i       ) } )
      :sliderRed           :connect( "valueChanged(int)"       , {|i| ::execEvent( __sliderValue_changed__                  , i, "R"  ) } )
      :sliderGreen         :connect( "valueChanged(int)"       , {|i| ::execEvent( __sliderValue_changed__                  , i, "G"  ) } )
      :sliderBlue          :connect( "valueChanged(int)"       , {|i| ::execEvent( __sliderValue_changed__                  , i, "B"  ) } )
      :radioSec1           :connect( "clicked()"               , {| | ::execEvent( __radioSection_clicked__                 , 1       ) } )
      :radioSec2           :connect( "clicked()"               , {| | ::execEvent( __radioSection_clicked__                 , 2       ) } )
      :radioSec3           :connect( "clicked()"               , {| | ::execEvent( __radioSection_clicked__                 , 3       ) } )
      :radioSec4           :connect( "clicked()"               , {| | ::execEvent( __radioSection_clicked__                 , 4       ) } )
      :radioSec5           :connect( "clicked()"               , {| | ::execEvent( __radioSection_clicked__                 , 5       ) } )
      :buttonThmAdd        :connect( "clicked()"               , {| | ::execEvent( __buttonThmAdd_clicked__                           ) } )
      :buttonThmDel        :connect( "clicked()"               , {| | ::execEvent( __buttonThmDel_clicked__                           ) } )
      :buttonThmApp        :connect( "clicked()"               , {| | ::execEvent( __buttonThmApp_clicked__                           ) } )
      :buttonThmSav        :connect( "clicked()"               , {| | ::execEvent( __buttonThmSav_clicked__                           ) } )
      :listThemes          :connect( "currentRowChanged(int)"  , {|i| ::execEvent( __listThemes_currentRowChanged__         , i       ) } )
      :buttonPathHrbRoot   :connect( "clicked()"               , {| | ::execEvent( __buttonHrbRoot_clicked__                          ) } )
      :buttonPathHbmk2     :connect( "clicked()"               , {| | ::execEvent( __buttonHbmk2_clicked__                            ) } )
      :buttonPathEnv       :connect( "clicked()"               , {| | ::execEvent( __buttonEnv_clicked__                              ) } )
      :buttonPathResources :connect( "clicked()"               , {| | ::execEvent( __buttonResources_clicked__                        ) } )
      :buttonPathTemp      :connect( "clicked()"               , {| | ::execEvent( __buttonTemp_clicked__                             ) } )
      :buttonPathShortcuts :connect( "clicked()"               , {| | ::execEvent( __buttonShortcuts_clicked__                        ) } )
      :buttonPathSnippets  :connect( "clicked()"               , {| | ::execEvent( __buttonSnippets_clicked__                         ) } )
      :buttonPathThemes    :connect( "clicked()"               , {| | ::execEvent( __buttonThemes_clicked__                           ) } )
      :buttonViewIni       :connect( "clicked()"               , {| | ::execEvent( __buttonViewIni_clicked__                          ) } )
      :buttonViewEnv       :connect( "clicked()"               , {| | ::execEvent( __buttonViewEnv_clicked__                          ) } )
      :buttonViewSnippets  :connect( "clicked()"               , {| | ::execEvent( __buttonViewSnippets_clicked__                     ) } )
      :buttonViewThemes    :connect( "clicked()"               , {| | ::execEvent( __buttonViewThemes_clicked__                       ) } )
      :comboTabsShape      :connect( "currentIndexChanged(int)", {|i| ::execEvent( __comboTabsShape_currentIndexChanged__   , i       ) } )
      :comboLeftTabPos     :connect( "currentIndexChanged(int)", {|i| ::execEvent( __comboLeftTabPos_currentIndexChanged__  , i       ) } )
      :comboTopTabPos      :connect( "currentIndexChanged(int)", {|i| ::execEvent( __comboTopTabPos_currentIndexChanged__   , i       ) } )
      :comboRightTabPos    :connect( "currentIndexChanged(int)", {|i| ::execEvent( __comboRightTabPos_currentIndexChanged__ , i       ) } )
      :comboBottomTabPos   :connect( "currentIndexChanged(int)", {|i| ::execEvent( __comboBottomTabPos_currentIndexChanged__, i       ) } )
      :comboTBSize         :connect( "currentIndexChanged(int)", {|i| ::execEvent( __comboTBSize_currentIndexChanged__      , i       ) } )
      :buttonVSSExe        :connect( "clicked()"               , {| | ::execEvent( __buttonVSSExe_clicked__                           ) } )
      :buttonVSSDatabase   :connect( "clicked()"               , {| | ::execEvent( __buttonVSSDatabase_clicked__                      ) } )
      :tableVar            :connect( "itemActivated(QTableWidgetItem*)", {|p| ::execEvent( __tableVar_keyPress__, p                   ) } )
      /* Dictionaries */
      :listDictNames       :connect( "currentRowChanged(int)"  , {|i| ::execEvent( __listDictNames_currentRowChanged__      , i       ) } )
      :btnDictColorText    :connect( "clicked()"               , {| | ::execEvent( __btnDictColorText_clicked__                       ) } )
      :btnDictColorBack    :connect( "clicked()"               , {| | ::execEvent( __btnDictColorBack_clicked__                       ) } )
      :buttonDictAdd       :connect( "clicked()"               , {| | ::execEvent( __buttonDictAdd_clicked__                          ) } )
      :buttonDictDelete    :connect( "clicked()"               , {| | ::execEvent( __buttonDictDelete_clicked__                       ) } )
      :listSourcePaths     :connect( "currentRowChanged(int)"  , {|i| ::execEvent( __listSourcePaths_currentRowChanged__ , i          ) } )
      :btnSourcePathsAdd   :connect( "clicked()"               , {| | ::execEvent( __buttonSourcePathsAdd_clicked__                   ) } )
      :btnSourcePathsDel   :connect( "clicked()"               , {| | ::execEvent( __buttonSourcePathsDel_clicked__                   ) } )
      :listIncludePaths    :connect( "currentRowChanged(int)"  , {|i| ::execEvent( __listIncludePaths_currentRowChanged__, i          ) } )
      :btnIncludePathsAdd  :connect( "clicked()"               , {| | ::execEvent( __buttonIncludePathsAdd_clicked__                  ) } )
      :btnIncludePathsDel  :connect( "clicked()"               , {| | ::execEvent( __buttonIncludePathsDel_clicked__                  ) } )
      :checkDictActive     :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictActive_stateChanged__   , i             ) } )
      :checkDictToPrg      :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToPrg_stateChanged__    , i             ) } )
      :checkDictToC        :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToC_stateChanged__      , i             ) } )
      :checkDictToCpp      :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToCpp_stateChanged__    , i             ) } )
      :checkDictToCh       :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToCh_stateChanged__     , i             ) } )
      :checkDictToH        :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToH_stateChanged__      , i             ) } )
      :checkDictToIni      :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToIni_stateChanged__    , i             ) } )
      :checkDictToTxt      :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToTxt_stateChanged__    , i             ) } )
      :checkDictToHbp      :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictToHbp_stateChanged__    , i             ) } )
      :checkDictCaseSens   :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictCaseSens_stateChanged__ , i             ) } )
      :checkDictBold       :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictBold_stateChanged__     , i             ) } )
      :checkDictItalic     :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictItalic_stateChanged__   , i             ) } )
      :checkDictULine      :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictULine_stateChanged__    , i             ) } )
      :checkDictColorText  :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictColorText_stateChanged__, i             ) } )
      :checkDictColorBack  :connect( "stateChanged(int)"       , {|i| ::execEvent( __checkDictColorBack_stateChanged__, i             ) } )
      :radioDictConvNone   :connect( "clicked()"               , {| | ::execEvent( __radioDictConvNone_clicked__                      ) } )
      :radioDictToLower    :connect( "clicked()"               , {| | ::execEvent( __radioDictToLower_clicked__                       ) } )
      :radioDictToUpper    :connect( "clicked()"               , {| | ::execEvent( __radioDictToUpper_clicked__                       ) } )
      :radioDictAsIn       :connect( "clicked()"               , {| | ::execEvent( __radioDictAsIn_clicked__                          ) } )
      :chkExtBuildLaunch   :connect( "stateChanged(int)"       , {|i| ::oINI:lExtBuildLaunch := ( i == 2 )                              } )
      :checkSplitVertical  :connect( "stateChanged(int)"       , {|i| ::oINI:lSplitVertical := ( i == 2 )                               } )
   ENDWITH
   RETURN Self
...
METHOD IdeSetup:retrieve()
   LOCAL a_, i, s, qItm
   WITH OBJECT ::oINI
      :cLineEndingMode          := iif( ::oUI:radioLineEndCRLF : isChecked(), "CRLF", ;
      ...
      :lTrimTrailingBlanks      := ::oUI:checkTrimTrailingBlanks      : isChecked()
      :lSaveSourceWhenComp      := ::oUI:checkSaveSourceWhenComp      : isChecked()
      :lSupressHbKWordsToUpper  := ::oUI:checkSupressHbKWordsToUpper  : isChecked()
      :lReturnAsBeginKeyword    := ::oUI:checkReturnAsBeginKeyword    : isChecked()
      :lConvTabToSpcWhenLoading := ::oUI:checkConvTabToSpcWhenLoading : isChecked()
      :lTabToSpcInEdits         := ::oUI:checkTabToSpcInEdits         : isChecked()
      :lAutoIndent              := ::oUI:checkAutoIndent              : isChecked()
      :lSmartIndent             := ::oUI:checkSmartIndent             : isChecked()
      :nTabSpaces               := val( ::oUI:editTabSpaces           : text() )
      :nIndentSpaces            := val( ::oUI:editIndentSpaces        : text() )
      :lEditsMdi                := ::oUI:checkEditsMdi                : isChecked()
      :lSelToolbar              := ::oUI:checkShowSelToolbar          : isChecked()
      //      
      :aKeywords := {}
      FOR EACH a_ IN ::aKeyItems
         aadd( :aKeywords, { alltrim( ::aKeyItems[ a_:__enumIndex(),1 ]:text() ), alltrim( ::aKeyItems[ a_:__enumIndex(),2 ]:text() ) } )
      NEXT
      s := ""
      FOR i := 1 TO :listTextExt:count()
         qItm := :listTextExt:item( i - 1 )
         s += "." + qItm:text() + ","
      NEXT
      s := substr( s, 1, Len( s ) - 1 )
      :cTextFileExtensions      := s
      //
      :nTmpBkpPrd               := val( ::oUI:editTmpBkpPrd : text() )
      :cBkpPath                 := ::oUI:editBkpPath        : text()
      :cBkpSuffix               := ::oUI:editBkpSuffix      : text()
      :lCompletionWithArgs      := ::oUI:checkListlWithArgs : isChecked()
      :lCompleteArgumented      := ::oUI:checkCmplInclArgs  : isChecked()
      /* Paths */
      :cPathHrbRoot             := ::oUI:editPathHrbRoot    : text()
      :cPathHbMk2               := ::oUI:editPathHbMk2      : text()
      :cPathResources           := ::oUI:editPathResources  : text()
      :cPathTemp                := ::oUI:editPathTemp       : text()
      :cPathEnv                 := ::oUI:editPathEnv        : text()
      :cPathShortcuts           := ::oUI:editPathShortcuts  : text()
      :cPathSnippets            := ::oUI:editPathSnippets   : text()
      :cPathThemes              := ::oUI:editPathThemes     : text()
      /* Intelli-sense */
      :lISClosing               := ::oUI:grpISClosing       : isChecked()
      :lISIf                    := ::oUI:chkISIf            : isChecked()
      :lISFor                   := ::oUI:chkISFor           : isChecked()
      :lISDoWhile               := ::oUI:chkISDoWhile       : isChecked()
      :lISDoCase                := ::oUI:chkISDoCase        : isChecked()
      :lISSwitch                := ::oUI:chkISSwitch        : isChecked()
      :lISElse                  := ::oUI:chkISElse          : isChecked()
      :lISCaseOWise             := ::oUI:chkISCaseOWise     : isChecked()
      :lISSwitchOWise           := ::oUI:chkISSwitchOWise   : isChecked()
      :lISExitSameLine          := ::oUI:chkISExitSameLine  : isChecked()
      :nISCaseCases             := ::oUI:spinISCaseCases    : value()
      :nISSwitchCases           := ::oUI:spinISSwitchCases  : value()
      :lISClosingP              := ::oUI:chkISClosingP      : isChecked()
      :lISSpaceP                := ::oUI:chkISSpaceP        : isChecked()
      :lISCodeBlock             := ::oUI:chkISCodeBlock     : isChecked()
      :lISOperator              := ::oUI:chkISOperator      : isChecked()
      :lISAlignAssign           := ::oUI:chkISAlignAssign   : isChecked()
      :lISFmtLine               := ::oUI:chkISFmtLine       : isChecked()
      :lISEmbrace               := ::oUI:ChkISEmbrace       : isChecked()
      :lISLocal                 := ::oUI:chkISLocal         : isChecked()
      :lISReturn                := ::oUI:chkISReturn        : isChecked()
      :lISSeparator             := ::oUI:chkISSeparator     : isChecked()
      :lISDocs                  := ::oUI:chkISDocs          : isChecked()
      :lISFunction              := ::oUI:grpISFunction      : isChecked()
      :lISClass                 := ::oUI:grpISClass         : isChecked()
      :cISData                  := ::oUI:comboISData        : currentText()
      :cISMethods               := ::oUI:comboISMethods     : currentText()
      :cISFormat                := ::oUI:comboISFormat      : currentText()
      :lTabRemoveExt            := ::oUI:chkTabRemoveExt    : isChecked()
      :lTabAddClose             := ::oUI:chkTabAddClose     : isChecked()
      :lExtBuildLaunch          := ::oUI:chkExtBuildLaunch  : isChecked()
      :lSplitVertical           := ::oUI:checkSplitVertical : isChecked()
   ENDWITH 
   RETURN Self
...
METHOD IdeSetup:populate()
   LOCAL s, a_
   WITH OBJECT ::oUI
      :checkAnimated                : setChecked( val( ::oINI:cIdeAnimated ) > 0      )
      :checkHilightLine             : setChecked( ::oIde:lCurrentLineHighlightEnabled )
      :checkHorzRuler               : setChecked( ::oIde:lHorzRulerVisible            )
      :checkLineNumbers             : setChecked( ::oIde:lLineNumbersVisible          )
      :checkShowLeftToolbar         : setChecked( ::oINI:lShowEditsLeftToolbar        )
      :checkShowTopToolbar          : setChecked( ::oINI:lShowEditsTopToolbar         )
      /* Line Ending Mode */
      s := ::oINI:cLineEndingMode
      //
      :radioLineEndCRLF             : setChecked( s == "CRLF" .OR. empty( s )         )
      :radioLineEndCR               : setChecked( s == "CR"                           )
      :radioLineEndLF               : setChecked( s == "LF"                           )
      :radioLineEndOS               : setChecked( s == "OS"                           )
      :radioLineEndAuto             : setChecked( s == "AUTO"                         )
      
      :checkTrimTrailingBlanks      : setChecked( ::oINI:lTrimTrailingBlanks          )
      :checkSaveSourceWhenComp      : setChecked( ::oINI:lSaveSourceWhenComp          )
      :checkSupressHbKWordsToUpper  : setChecked( ::oINI:lSupressHbKWordsToUpper      )
      :checkReturnAsBeginKeyword    : setChecked( ::oINI:lReturnAsBeginKeyword        )
      :checkConvTabToSpcWhenLoading : setChecked( ::oINI:lConvTabToSpcWhenLoading     )
      :checkTabToSpcInEdits         : setChecked( ::oINI:lTabToSpcInEdits             )
      :checkAutoIndent              : setChecked( ::oINI:lAutoIndent                  )
      :checkSmartIndent             : setChecked( ::oINI:lSmartIndent                 )
      :editTabSpaces                : setText( hb_ntos( ::oIde:nTabSpaces    )        )
      :editIndentSpaces             : setText( hb_ntos( ::oINI:nIndentSpaces )        )
      :checkEditsMdi                : setChecked( ::oINI:lEditsMdi                    )
      :checkShowSelToolbar          : setChecked( ::oINI:lSelToolbar                  )
      /* Paths */
      :editPathIni                  : setText( ::oIde:cProjIni                        )
      //
      :editPathHrbRoot              : setText( ::oINI:cPathHrbRoot                    )
      :editPathHbMk2                : setText( ::oINI:cPathHbMk2                      )
      :editPathResources            : setText( ::oINI:cPathResources                  )
      :editPathTemp                 : setText( ::oINI:cPathTemp                       )
      :editPathEnv                  : setText( ::oINI:cPathEnv                        )
      :editPathShortcuts            : setText( ::oINI:cPathShortcuts                  )
      :editPathSnippets             : setText( ::oINI:cPathSnippets                   )
      :editPathThemes               : setText( ::oINI:cPathThemes                     )
      /* Variables */
      :tableVar:clearContents()
      ::aKeyItems := {}
      ...
      FOR EACH s IN a_
         :listTextExt:addItem( strtran( s, "." ) )
      NEXT
      :listTextExt:setSortingEnabled( .t. )
      :listTextExt:sortItems()
      :editTmpBkpPrd      : setText( hb_ntos( ::oINI:nTmpBkpPrd ) )
      :editBkpPath        : setText( ::oINI:cBkpPath   )
      :editBkpSuffix      : setText( ::oINI:cBkpSuffix )
      /* Selections - Code Completion */
      :checkListlWithArgs : setChecked( ::oINI:lCompletionWithArgs )
      :checkCmplInclArgs  : setChecked( ::oINI:lCompleteArgumented )
      /* Themes */
      ...
      :editSec1:setText( "0" )
      :editSec5:setText( "1" )
      :editSec1:setReadOnly( .t. )
      :editSec5:setReadOnly( .t. )
      /* Dock Widgets */
      :comboTabsShape     : setCurrentIndex( ::oINI:nDocksTabShape     )
      :comboLeftTabPos    : setCurrentIndex( ::oINI:nDocksLeftTabPos   )
      :comboTopTabPos     : setCurrentIndex( ::oINI:nDocksTopTabPos    )
      :comboRightTabPos   : setCurrentIndex( ::oINI:nDocksRightTabPos  )
      :comboBottomTabPos  : setCurrentIndex( ::oINI:nDocksBottomTabPos )
      :editVSSExe         : setText( ::oINI:cVSSExe      )
      :editVSSDatabase    : setText( ::oINI:cVSSDatabase )
      /* Intelli-sense */
      :grpISClosing       : setChecked( ::oINI:lISClosing      )
      :chkISIf            : setChecked( ::oINI:lISIf           )
      :chkISFor           : setChecked( ::oINI:lISFor          )
      :chkISDoWhile       : setChecked( ::oINI:lISDoWhile      )
      :chkISDoCase        : setChecked( ::oINI:lISDoCase       )
      :chkISSwitch        : setChecked( ::oINI:lISSwitch       )
      :chkISElse          : setChecked( ::oINI:lISElse         )
      :chkISCaseOWise     : setChecked( ::oINI:lISCaseOWise    )
      :chkISSwitchOWise   : setChecked( ::oINI:lISSwitchOWise  )
      :chkISExitSameLine  : setChecked( ::oINI:lISExitSameLine )
      :spinISCaseCases    : setValue(   ::oINI:nISCaseCases    )
      :spinISSwitchCases  : setValue(   ::oINI:nISSwitchCases  )
      :chkISClosingP      : setChecked( ::oINI:lISClosingP     )
      :chkISSpaceP        : setChecked( ::oINI:lISSpaceP       )
      :chkISCodeBlock     : setChecked( ::oINI:lISCodeBlock    )
      :chkISOperator      : setChecked( ::oINI:lISOperator     )
      :chkISAlignAssign   : setChecked( ::oINI:lISAlignAssign  )
      :chkISFmtLine       : setChecked( ::oINI:lISFmtLine      )
      :chkISEmbrace       : setChecked( ::oINI:lISEmbrace      )
      :chkISLocal         : setChecked( ::oINI:lISLocal        )
      :chkISReturn        : setChecked( ::oINI:lISReturn       )
      :chkISSeparator     : setChecked( ::oINI:lISSeparator    )
      :chkISDocs          : setChecked( ::oINI:lISDocs         )
      :grpISFunction      : setChecked( ::oINI:lISFunction     )
      :grpISClass         : setChecked( ::oINI:lISClass        )
      :comboISData        : setCurrentIndex( iif( ::oINI:cISData == "VAR", 0, 1 ) )
      :comboISMethods     : setCurrentIndex( AScan( { "new", "new;create", "new;create;destroy" }, {|e| e == ::oINI:cISMethods } ) - 1 )
      :comboISFormat      : setCurrentIndex( iif( ::oINI:cISFormat == "class:method", 0, 1 ) )
      :chkTabRemoveExt    : setChecked( ::oINI:lTabRemoveExt   )
      :chkTabAddClose     : setChecked( ::oINI:lTabAddClose    )
      :chkTabAddClose     : setChecked( ::oINI:lTabAddClose    )
      :chkExtBuildLaunch  : setChecked( ::oINI:lExtBuildLaunch )
      :checkSplitVertical : setChecked( ::oINI:lSplitVertical  )
   ENDWITH 
   IF .T.
      ::connectSlots()
      ::pushThemesData()
...
METHOD IdeSetup:show()
   LOCAL cStyle
   IF empty( ::oUI )
      WITH OBJECT ::oUI := hbide_getUI( "setup", ::oDlg:oWidget )
         :setWindowFlags( Qt_Sheet )
         :setMaximumWidth( ::oUI:width() )
         :setMinimumWidth( ::oUI:width() )
         :setMaximumHeight( ::oUI:height() )
         :setMinimumHeight( ::oUI:height() )
         ::buildTree()
         ::buildKeywords()
         /* Dock Widgets */
         :comboTabsShape:addItem( "Rounded" )
         :comboTabsShape:addItem( "Triangular" )
         WITH OBJECT :comboLeftTabPos       
            :addItem( "Top"    )
            :addItem( "Bottom" )
            :addItem( "Left"   )
            :addItem( "Right"  )
         ENDWITH 
         WITH OBJECT :comboTopTabPos       
            :addItem( "Top"    )
            :addItem( "Bottom" )
            :addItem( "Left"   )
            :addItem( "Right"  )
         ENDWITH 
         WITH OBJECT :comboBottomTabPos       
            :addItem( "Top"    )
            :addItem( "Bottom" )
            :addItem( "Left"   )
            :addItem( "Right"  )
         ENDWITH 
         WITH OBJECT :comboRightTabPos       
            :addItem( "Top"    )
            :addItem( "Bottom" )
            :addItem( "Left"   )
            :addItem( "Right"  )
         ENDWITH 
         :editFontName:setText( ::oINI:cFontName )
         :editPointSize:setText( hb_ntos( ::oINI:nPointSize ) )
         FOR EACH cStyle IN ::aStyles
            :comboStyle:addItem( cStyle )
         NEXT
         :comboStyle:setCurrentIndex( ascan( ::aStyles, {|e| e == ::oINI:cIdeTheme } ) - 1 )
         aeval( ::aTBSize, {|e| ::oUI:comboTBSize:addItem( e ) } )
         :comboTBSize:setCurrentIndex( ascan( ::aTBSize, {|e| e == ::oINI:cToolbarSize } ) - 1 )
         /* Intelli-sense */
         :comboISData    : addItem( "VAR" )
         :comboISData    : addItem( "DATA" )
         //         
         :comboISMethods : addItem( "new" )
         :comboISMethods : addItem( "new;create" )
         :comboISMethods : addItem( "new;create;destroy" )
         //
         :comboISFormat  : addItem( "class:method" )
         :comboISFormat  : addItem( "method CLASS class" )
         //
         ::setIcons()
         ::connectSlots()
         //
...
METHOD IdeSetup:viewIt( cFileName, lSaveAs, lSave, lReadOnly, lApplyHiliter )
   LOCAL oUI
   WITH OBJECT oUI := hbide_getUI( "editor", ::oUI:oWidget )
      :setWindowFlags( Qt_Sheet + Qt_CustomizeWindowHint + Qt_WindowTitleHint + Qt_WindowContextHelpButtonHint )
      :buttonSaveAs:setEnabled( lSaveAs )
      :buttonSave:setEnabled( lSave )
      WITH OBJECT :plainText()
         :setReadOnly( lReadOnly )
         :setLineWrapMode( QPlainTextEdit_NoWrap )
         :setPlainText( hb_memoRead( cFileName ) )
         :setFont( ::oIde:oFont:oWidget )
      ENDWITH 
      IF lApplyHiliter
         aadd( ::aHilighters, ::oTH:setSyntaxHilighting( oUI:plainText, "Bare Minimum" ) )
      ENDIF
      :oWidget     :connect( QEvent_Close, {|| ::execEvent( __buttonEditorX_clicked__     , oUI            ) } )
      :buttonSaveAs:connect( "clicked()" , {|| ::execEvent( __buttonEditorSaveAs_clicked__, oUI, cFileName ) } )
      :buttonSave  :connect( "clicked()" , {|| ::execEvent( __buttonEditorSave_clicked__  , oUI, cFileName ) } )
      :buttonClose :connect( "clicked()" , {|| ::execEvent( __buttonEditorClose_clicked__ , oUI            ) } )
      :show()
   ENDWITH 
   RETURN Self
...
METHOD IdeSetup:populateThemeColors( nSlot, aRGB )
   ...
   ENDIF
   WITH OBJECT { ::oUI:frameSec1, ::oUI:frameSec2, ::oUI:frameSec3, ::oUI:frameSec4, ::oUI:frameSec5 }[ nSlot ]
      :setStyleSheet( "background-color: " + hbide_rgbString( aRGB ) + ";" )
   ENDWITH 
   RETURN Self
...
METHOD IdeSetup:buildTree()
   ...
   WITH OBJECT oRoot := QTreeWidgetItem()
      ...
      :setToolTip( 0, "Parts" )
   ENDWITH 
   WITH OBJECT ::oUI:treeWidget()
      :setHeaderHidden( .t. )
      :setIconSize( QSize( 12,12 ) )
      :setIndentation( 12 )
      :addTopLevelItem( oRoot )
   ENDWITH 
   aadd( ::aItems, oRoot )
   FOR EACH s IN ::aTree
