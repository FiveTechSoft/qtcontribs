...
METHOD XbpFileDialog:connect()
   WITH OBJECT ::oWidget
      :connect( "finished(int)"             , {|| ::disconnect() } )
      ...
      :connect( "currentChanged(QString)"   , {|p| ::execSlot( "currentChanged(QString)"   , p ) } )
      :connect( "directoryEntered(QString)" , {|p| ::execSlot( "directoryEntered(QString)" , p ) } )
      :connect( "fileSelected(QString)"     , {|p| ::execSlot( "fileSelected(QString)"     , p ) } )
      :connect( "filesSelected(QStringList)", {|p| ::execSlot( "filesSelected(QStringList)", p ) } )
      :connect( "filterSelected(QString)"   , {|p| ::execSlot( "filterSelected(QString)"   , p ) } )
#endif
   ENDWITH
   RETURN NIL
...
METHOD XbpFileDialog:disconnect()
   WITH OBJECT ::oWidget   
      :disconnect( "rejected()"    )
      :disconnect( "finished(int)" )
#if 0
      :disconnect( "accepted()"                 )
      :disconnect( "finished(int)"              )
      :disconnect( "currentChanged(QString)"    )
      :disconnect( "directoryEntered(QString)"  )
      :disconnect( "fileSelected(QString)"      )
      :disconnect( "filesSelected(QStringList)" )
      :disconnect( "filterSelected(QString)"    )
#endif
   ENDWITH 
   RETURN NIL
